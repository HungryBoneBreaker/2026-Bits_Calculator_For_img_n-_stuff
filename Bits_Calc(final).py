...
def instructions():
    ...
    xxx to break
    image, picture, img, p to calculate an image
    int, integer to calculate an integer
    txt, text, or T to calculate text
    When the user types in "i", they'll be asked whether you meant integer or image\n''')
...
def get_filetype():
    while True:
        ...
        # if the response is INVALID
            ...
            print("Please only file types that are valid")
...
if file_type : print("Well have a good day and"
